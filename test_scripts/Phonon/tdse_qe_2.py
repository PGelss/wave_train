...
def phonon_qe_2(batch_mode):
    ...
    dynamics = TDSE(
        ...
        solver='se',                     # can be 'se' (symmetrized Euler) or 'sm' (Strang-Marchuk splitting) or ...
        ...
        load_file='exact_09.pic',        # if not None, reference data will be loaded from this file
