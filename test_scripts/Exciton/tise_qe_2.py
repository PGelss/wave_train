...
def exciton_tise(batch_mode):
    ...
    dynamics = TISE(
        ...
        n_levels=7,                      # number of energy levels: ground and singly excited
        ...
        load_file='quasi.pic',           # if not None, reference data will be loaded from this file
        compare='psi'                    # type of comparison with reference data
    )
    ...
    # Interactive mode: Setup animated visualization
        ...
        graphics = VisualTISE(
            ...
            plot_type='QuantNumbers',    # select your favorite plot style
