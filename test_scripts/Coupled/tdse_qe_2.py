...
def coupled_qe_2(batch_mode):
    ...
    hamilton.get_TT(
        n_basis=[2, 8],                  # sizes of excitonic and phononic basis set
    ...
    dynamics = TDSE(
        ...
        load_file='exact_3.pic',         # if not None, reference data will be loaded from this file
