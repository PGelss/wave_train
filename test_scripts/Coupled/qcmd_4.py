...
def coupled_qcmd(batch_mode):
    ...
    hamilton = Coupled(
        ...
        sig=1.6e-4,                      # exciton-phonon tuning: symmetrized
    ...
    # Set up initial state: Sech-Function, from Matlab: Batch_Scripts/Coupled/TISE/N40_sech.m
    dynamics.sec_hyp(w_0=0.65)           # Fit from our TISE_TT_1 paper for sig = 1.8E-4
